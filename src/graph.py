...
class Graph:
    ...
    def get_weight(self, node1: Node, node2: Node) -> float:
        # Check if node1 and node2 are neighbors and return the distance between them else return infinity
    ...
    def dijkstra_algorithm(self, start_node: Node, stop_node: Node):
